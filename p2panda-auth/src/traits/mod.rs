...
/// long byte string.
pub trait IdentityHandle: Copy + Debug + PartialEq + Eq + StdHash + Nameables + 'static {}
...
/// hash.
pub trait OperationId: Copy + Debug + PartialEq + Eq + StdHash + Nameables + 'static {}

/// Conditions associated with an actors access level.
pub trait Conditions: Clone + Debug + PartialEq + PartialOrd + Nameables + 'static {}
